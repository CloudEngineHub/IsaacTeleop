...
public:
    ...
    const Serialized<HapticCommandTracked>& get_data(const ITrackerSession& session) const;
    ...
    const Serialized<HapticCommandTracked>& get_data(const ITrackerSession& session, std::string_view endpoint) const;
